...
import { ThemeContext, SearchedCountryContext } from './context/AppContext';
import {requestCountries, searchCountry} from './helpers/RequestCountries'
...
function App() {
  ...
  const [searchedCountry, setSearchedCountry] = useState({} as Countries[])
  ...
  useEffect(() => {
    if(Object.keys(searchedCountry)){
