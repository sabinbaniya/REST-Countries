...
const Card: React.FunctionComponent<IAppProps> = ({name, flag, population, region, capital}) => {
  return (
      <div className="dark:bg-DarkBlue  max-w-xl bg-White rounded-md my-4 mx-auto md:max-w-xs lg:w-72 xl:w-64 dark:text-White text-LightVeryDarkBlue max-h-90 drop-shadow cursor-pointer hover:scale-105 transition-transform" key={population+Math.random()}>
          <div className="h-1/2 ">
