...
const Searchbar: React.FunctionComponent= () => {
  return (
      <div className="mx-auto py-8 dark:bg-VeryDarkBlue w-full md:max-w-xs md:mx-0 lg:max-w-md relative z-30">
          <div className="flex items-center relative drop-shadow absolute z-40">
